...
(function($, window) {
	...
	jHtmlArea.fn = jHtmlArea.prototype = {
		...
		getSelection : function() {
			if ($browser.msie === true && $browser.version < 11) {
				// return (this.editor.parentWindow.getSelection) ?
				// this.editor.parentWindow.getSelection() :
	...
	var priv = {
				...
				for (var i = 0; i < arr.length; i++) {
					...
					if ((typeof (e)).toLowerCase() === "string") {
						if (e === "|") {
							...
							var f = (function(e) {
								// If button name exists in priv.toolbarButtons
								// then call the "method" defined there,
								// otherwise call the method with the same name
		...
		attachEditorEvents : function() {
			...
			// $(this.textarea[0].form).submit(function() {
